...
class Pagination{ 
    ...
    var $numLinks       =  3; 
    var $currentPage    =  0; 
    var $firstLink      = '&lsaquo; Primera'; 
    var $nextLink       = '&gt;'; 
    var $prevLink       = '&lt;'; 
    var $lastLink       = 'Ultima &rsaquo;'; 
    ...
    function createLinks(){  
        ...
        if ($numPages == 1){ 
            if ($this->showCount){ 
                $info = '<p>Viendo : ' . $this->totalRows.'</p>'; 
                return $info; 
            }else{ 
                return ''; 
            } 
        ...
        if ($this->showCount){ 
           ...
           $info = 'Viendo ' . ( $currentOffset + 1 ) . ' hasta ' ; 
    ...
    function getAJAXlink( $count, $text) { 
        ...
        return "<a class='paginacion' href=\"javascript:void(0);\" " . $this->anchorClass . " 
                ". $linkClick .">". $text .'</a>'; 
    } 
} 
?>